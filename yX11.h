...
/*---(informational-only)-------------*/
char        yX11_desk_current       (char *a_name);
char        yX11_desk_cursor        (char a_move, char *a_name);
char        yX11_desk_find          (char *a_regex, char *a_name, int *a_count);
...
long        yX11_win_cursor         (char a_desk, char a_move, char *a_name);
